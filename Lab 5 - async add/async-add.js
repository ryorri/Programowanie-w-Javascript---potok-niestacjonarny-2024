...
const _100ele = [1,2,2,2,2,2,2,2,2,2,
                2,2,2,2,2,2,2,2,2,2,
                2,2,2,2,2,2,2,2,2,2,
                2,2,2,2,2,2,2,2,2,2,
                2,2,2,2,2,2,2,2,2,2,
...
await measurePerformance('100 elems', () => _100Elems(_100ele), _100ele)
await measurePerformance('SomeElems', () => SomeElems(10,10))
...
async function _100Elems()
{
  let sum = 0;

  for (let item of _100ele) 
  {
    sum = await asyncAdd(sum, item)
  };
...
async function SomeElems(multi,val)
{
  let sum = 0;

  for (let i =0; i< multi;i++) 
  {
    sum = await asyncAdd(sum, val)
  };
